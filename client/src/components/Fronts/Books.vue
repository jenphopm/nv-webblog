<template>
  <div>
    ...
    <div class="component-wrapper">
      ...
      <transition-group name="fade">
        <div v-for="book in books" v-bind:key="book.id" class="book-list">
          ...
          <div class="book-info">
            ...
            <p>
              <button class="btn btn-sm btn-info" v-on:click="navigateTo('/front/read/'+ book.id)">
      ...
      <div v-if="books.length === 0 && loading === false" class="emptybook">*** ไม่มีข้อมูล ***</div>
...
export default {
  ...
  methods: {
    ...
    async refreshData() {
      this.books = (await BooksService.frontIndex()).data;
    },
    setCategory(keyword) {
      if (keyword === " ") {
        this.search = "";
